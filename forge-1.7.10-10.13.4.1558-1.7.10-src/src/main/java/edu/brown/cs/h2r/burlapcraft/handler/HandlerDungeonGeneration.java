...
import edu.brown.cs.h2r.burlapcraft.dungeongenerator.DungeonLocalizer;
...
public class HandlerDungeonGeneration implements IWorldGenerator {
	...
	public static void doCreateDungeons(World world) {
		...
		Pose localizerPose = Pose.fromXyz(playerSpawnPose.getX() - 40, playerSpawnPose.getY() + height + 80, playerSpawnPose.getZ() - 10);
		...
		//Terrence
		BurlapCraft.registerDungeon(new DungeonLocalizer(localizerPose));
